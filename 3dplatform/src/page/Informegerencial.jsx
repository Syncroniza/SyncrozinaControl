      ...
      <div>
        <div className="grid grid-cols-5">
          <Link to={"/informe/informeHC"}>
            <h1 className="flex justify-center ml-6 mt-6 bg-blue-500 rounded-xl p-2 text-white   text-sm ">
          ...
          <Link to={"/informe/dispobible"}>
            <h1 className="flex justify-center ml-6 mt-6 mr-2 bg-blue-500 rounded-xl p-2 text-white text-sm">
              DISPONIBLE
            </h1>
          </Link>
        </div>
