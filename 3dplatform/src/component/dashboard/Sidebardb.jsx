...
const Sidebardb = () => {
  return (
    <main>
      <div className="bg-gradient-to-r from-indigo-500 text-sm  w-60 mt-4 mb-4 p-2 rounded-lg ml-2 shadow-xl">
...
c-1 29 -137 983 -139 968z"
        ...
        <Link
          to={"/"}
          className=" gap-2 mt-2 mr-3 ml-2 flex text-white p-2 rounded-xs ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <Link
          to={"/oc"}
          className=" gap-2 mt-2 mr-3 ml-2 flex text-white p-2 rounded-lg ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
